      ...
      <div className={classes.mainfoot}>
        ...
        <div className={classes.footdown}>
          <div className={classes.social}>
            <ul>
              <li>
                <a href='https://www.facebook.com/ktj.iitkgp' target="_blank" rel="noopener noreferrer" className={classes.socialLink}><BsFacebook  size={21} className={classes.ii} /></a>
              </li>
              <li>
                <a href='https://www.instagram.com/ktj.iitkgp/' target="_blank" rel="noopener noreferrer" className={classes.socialLink}><BsInstagram size={21} className={classes.ii} /></a>
              </li>
              <li>
                <a href='https://twitter.com/ktj_iitkgp' target="_blank" rel="noopener noreferrer" className={classes.socialLink}><BsTwitter size={21}  className={classes.ii}/></a>
              </li>
              <li>
                <a href='https://www.linkedin.com/company/kshitij-iit-kharagpur/' target="_blank" rel="noopener noreferrer" className={classes.socialLink}><BsLinkedin size={21} className={classes.ii} /></a>
              </li>
              <li>
                <a href='https://www.youtube.com/ktjiitkgp' target="_blank" rel="noopener noreferrer" className={classes.socialLink}><BsYoutube size={21} className={classes.ii} /></a>
              </li>
            </ul>
          </div>
